...
import 'package:isaac/pages/first_page.dart';
import 'package:isaac/pages/second_page.dart';
import 'package:isaac/pages/third_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Burguer Granados',
      theme: ThemeData(
